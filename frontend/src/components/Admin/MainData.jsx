...
const MainData = () => {
    ...
    const { orders = [], totalCommission = 0, totalAmount = 0 } = useSelector((state) => state.allOrders) || {};
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-6">
                <div className="flex flex-col bg-indigo-700 text-white gap-2 rounded-xl shadow-lg hover:shadow-xl p-6">
                    <h4 className="text-gray-100 font-medium">Total Admin Commission</h4>
                    <h2 className="text-2xl font-bold">
                        Rs. {displayCommission?.toLocaleString(undefined, { maximumFractionDigits: 2 })}
                    </h2>
                </div>
