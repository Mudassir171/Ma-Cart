import React from 'react'; // Fix: React defined here
                ...
                {navMenu.map((item, index) => {
                    ...
                    return (
                        <React.Fragment key={index}>
                            {label === "Logout" ? (
                                <button onClick={handleLogout} className="hover:bg-gray-700 flex gap-3 items-center py-3 px-4 font-medium w-full text-left">
                                    <span>{icon}</span>
                                    <span>{label}</span>
                                </button>
                            ) : (
