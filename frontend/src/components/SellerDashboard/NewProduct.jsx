    ...
    <>
      ...
      >
        <div className="flex flex-col gap-3 m-2 sm:w-1/2">
          ...
          <label className="flex items-center gap-2 px-3 py-2 bg-emerald-50 border border-emerald-200 rounded-lg text-xs font-bold text-emerald-900">
            <input
              type="checkbox"
              checked={isFlashSale}
              onChange={(e) => setIsFlashSale(e.target.checked)}
            />
            Add this product to Flash Sale section
          </label>
          ...
          <div className="flex flex-col gap-2">
            <label className="font-bold text-gray-700 uppercase text-xs tracking-widest">
              Colors
            </label>
            <div className="flex justify-between items-center border rounded">
              <input
                ...
                type="text"
                placeholder="Add Color (e.g. Red, Black)"
                className="px-2 flex-1 outline-none border-none py-1.5"
              />
              <span
                onClick={addColor}
                className="py-2 px-6 bg-blue-600 text-white rounded-r cursor-pointer font-bold text-xs uppercase"
              >
                Add
              </span>
            </div>
            <div className="flex flex-wrap gap-1.5">
              {colors.map((c, i) => (
                <div
                  key={i}
                  className="flex justify-between items-center py-1 px-3 bg-purple-50 rounded-full border border-purple-200 gap-2"
                >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-1.5">
              {sizes.map((s, i) => (
                <div
                  key={i}
                  className="flex justify-between items-center py-1 px-3 bg-indigo-50 rounded-full border border-indigo-200 gap-2"
                >
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center border rounded">
              ...
              <span
                ...
                className="py-2 px-6 bg-blue-600 text-white rounded-r cursor-pointer font-bold"
              >
                Add
              </span>
            </div>
          ...
          <h2 className="font-bold text-gray-700 uppercase text-xs mt-2 tracking-widest">
            Brand Details
          </h2>
        ...
        <div className="flex flex-col gap-2 m-2 sm:w-1/2">
          <h2 className="font-bold text-gray-700 uppercase text-xs tracking-widest">
            Specifications
          </h2>
          <div className="flex justify-evenly gap-2 items-center">
            ...
            <span
              onClick={addSpecs}
              className="py-2 px-6 bg-blue-600 text-white rounded cursor-pointer font-bold"
            >
              Add
            </span>
          </div>
          <div className="flex flex-col gap-1.5 max-h-40 overflow-y-auto">
            {specs.map((spec, i) => (
              <div
                key={i}
                className="flex justify-between items-center text-sm rounded bg-blue-50 py-1.5 px-3"
              >
          ...
          <h2 className="font-bold text-gray-700 uppercase text-xs mt-4 tracking-widest">
            Product Gallery (1-5)
          </h2>
            ...
            {imagesPreview.length > 0 ? (
              imagesPreview.map((image, i) => (
                <img
                  ...
                  alt="Product"
                  key={i}
                  className="w-24 h-full object-contain border rounded-lg bg-white shadow-sm"
                />
              ))
            ) : (
              <p className="text-gray-400 text-xs m-auto italic">
          ...
          <div className="flex justify-end mt-4">
            <input
              type="submit"
              className="bg-[#f85606] uppercase w-full p-4 text-white font-black rounded-xl shadow-lg cursor-pointer hover:bg-[#d14905] transition-all tracking-widest"
