...
import { getCategories, updateCategory, deleteCategory, clearErrors } from '../../actions/categoryAction'; 
...
const CategoryTable = () => {
    ...
    useEffect(() => {
        ...
        dispatch(getCategories());
    }, [dispatch, error, isUpdated, isDeleted, updateError]);
    ...
    const columns = [
        ...
        {
            field: "types",
            headerName: "View Types (Dropdown)",
            flex: 1.5,
            headerAlign: 'center',
            align: 'center',
            renderCell: (params) => (
                <FormControl fullWidth size="small" sx={{ minWidth: 150 }}>
                    <Select
                        displayEmpty
                        value="" // Ise khali rakha hai taaki label hamesha nazar aaye
