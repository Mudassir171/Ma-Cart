...
const ResetPassword = () => {
  ...
  return (
    <>
      <MetaData title="Password Reset | Ma-Cart" />
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div class="flex flex-col w-full gap-4">
                  ...
                  <div class="flex flex-col gap-2.5 mt-2 mb-32">
                    ...
                    <button type="submit" class="text-white py-3 w-full bg-green-800 shadow hover:shadow-lg rounded-sm font-medium">Submit</button>
                  </div>
                  {/* <!-- button container --> */}
