...
const Register = () => {
    ...
    return (
        <>
            <MetaData title="Register | Ma-Cart" />
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-green-800 shadow hover:shadow-lg rounded-sm font-medium">Signup</button>
