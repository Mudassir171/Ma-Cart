        ...
        <div className="hidden sm:flex flex-col gap-4 w-1/4 px-1">
            ...
            <div className="flex flex-col bg-white rounded-sm shadow">
                ...
                <div className="flex items-center gap-5 px-4 py-4 border-b">
                    ...
                    <Link className="flex w-full justify-between font-medium text-gray-500 hover:text-primary-blue uppercase" to="/orders">
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    ...
                    <Link className="p-3 pl-14 hover:bg-blue-50 hover:text-primary-blue" to="/account">Manage Addresses</Link>
                    <Link className="p-3 pl-14 hover:bg-blue-50 hover:text-primary-blue" to="/account">PAN Card Information</Link>
                </div>

                {/* Payments */}
                <div className="flex items-center gap-5 px-4 py-4">
                    <span className="text-primary-blue"><AccountBalanceWalletIcon /></span>
                    <p className="flex w-full justify-between font-medium text-gray-500 uppercase">Payments</p>
                </div>
                <div className="flex flex-col pb-3 border-b text-sm">
                ...
                <div className="flex items-center gap-5 px-4 py-4">
                    ...
                    <p className="flex w-full justify-between font-medium text-gray-500 uppercase">My Stuff</p>
                </div>
                <div className="flex flex-col pb-3 border-b text-sm">
                    <Link className="p-3 pl-14 hover:bg-blue-50 hover:text-primary-blue" to="/wishlist">My Coupons</Link>
                    <Link className="p-3 pl-14 hover:bg-blue-50 hover:text-primary-blue" to="/orders">My Reviews & Ratings</Link>
                    
                    {/* Fixed: Notification Link instead of Component */}
                    <Link to="/notifications" className={`${activeTab === "notifications" ? "bg-blue-50 text-primary-blue font-medium" : "hover:bg-blue-50 hover:text-primary-blue"} p-3 pl-14`}>All Notifications</Link>
                ...
                <div className="flex items-center gap-5 px-4 py-4 border-b">
                    ...
                    <div className="flex w-full justify-between font-medium text-gray-500 hover:text-primary-blue cursor-pointer" onClick={handleLogout}>
                        Logout <span><ChevronRightIcon /></span>
                    </div>
                </div>
            </div>
        </div>
